...
const ProductDetails = () => {
  ...
  const {data,addItemCart:{loading,error,sucess}} = useSelector((state)=>state.cart)
      ...
      <div className={styles.uperDiv}>
        ...
        <div className={styles.detailsDiv}>
          ...
          <div className={styles.color}>
            <span className={styles.cspan}>COLOUR: </span> {productDetails.color}
          </div>
          <div className={styles.sizeDiv}>
            <h5 className={styles.sizeH}>SIZE:</h5>
            <div>
              <select className={styles.select} onChange={(e)=>{handleSize(e)}}>
         ...
         { selectSize && <div className={styles.chooseSize}>Please select from the available colour and size options</div>}
